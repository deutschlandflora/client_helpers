  ...
  */
  ...
  protected static function _get_cached_services_call($request, $options) {
    ...
    if (!isset($response) || $response===FALSE) {
      ...
      // The calling code should perhaps be redesigned, but in the meantime convert the call to use the existing POST functionality
      ...
      if(count($path) && $path[count($path)-1] === 'requestReport' && strlen($URL) > 8100 ) {
